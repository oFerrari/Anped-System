...
public class EquipamentoDTO implements Serializable{
	...
	public EquipamentoDTO(Long id, String nome, String descricao, String marca, CategoriaEquipamento categoria, String foto, Double valor, Integer quantidade) {
	...
	public EquipamentoDTO(Equipamento entity,List<EquipamentoItem> equipamentosItem) {
		this(entity);
		this.equipamentosItem = equipamentosItem.stream().map(x -> new EquipamentoItem(x.getId(), x.getNumeroSerie(), x.getSituacao(), null)).collect(Collectors.toList());
	}
